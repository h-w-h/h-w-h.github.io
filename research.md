...
> For other examples of operators and fixed pont problems, we refer the reader to [ADMM](https://web.stanford.edu/~boyd/admm.html) and to the method of [alternating projections](https://en.wikipedia.org/wiki/Projections_onto_convex_sets).
