...
## Overview ##
  ...
  Current particular specializations of interest include the intersection of iterative fixed point algorithms, variational modeling for image processing, asynchronous computations, and machine learning applications. Below we briefly describe each of these independently and note places where they intersect.
