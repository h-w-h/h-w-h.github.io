...
### *Machine Learning* ###
The term "machine learning" is a common buzzword nowadays. Although there are many wonderful applications, my particular research interest related to this field falls under the category of "learning to optimize". A recent paper about a proposed [ALISTA](https://openreview.net/pdf?id=B1lnzn0ctQ) method by my advisor and colleagues followed upon paper about [LISTA](https://dlnext.acm.org/doi/abs/10.5555/3104322.3104374). The LISTA paper took the idea of the iterative shrinking thresholding algorithm (ISTA) and generalized the form of this algorithm to enable its parameters to be "learned" by solving an optimization problem using relevant data sets. The ALISTA paper refined the LISTA paper in simplifying the machine learning problem by aiming to require learning fewer parameters. 
